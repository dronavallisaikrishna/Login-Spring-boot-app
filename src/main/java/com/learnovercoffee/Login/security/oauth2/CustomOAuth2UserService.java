package com.learnovercoffee.Login.security.oauth2;
...
import com.learnovercoffee.Login.security.oauth2.users.OAuth2UserInfo;
import com.learnovercoffee.Login.security.oauth2.users.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        User user = new User();
        System.out.println("Oauth user info is:-"+oAuth2UserInfo);
